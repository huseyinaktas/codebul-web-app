    ...
    return (
      <header>
        <nav className="container navbar navbar-expand-lg navbar-light justify-content-between">
          <a className="navbar-brand" href="http://www.google.com">CodeBul.<b>com</b></a>
          ...
          <div className="navbar-collapse" style={{ display: this.state.isNavOpen ? "block" : "none" }}>
            ...
            <ul className="navbar-nav">
              <li className="nav-item active">
                <Link to="/index" activeClassName="active" className="nav-link">Anasayfa</Link>
              </li>
              <li className="nav-item active">
              ...
              <li className="nav-item active">
                <Link to="/Referanlar" activeClassName="active" className="nav-link">Referanslar</Link>
              </li>
